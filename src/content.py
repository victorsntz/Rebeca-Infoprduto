...
DESAFIOS = [
    ...
    "Faça um culto em casa hoje: um louvor, uma leitura, uma oração. Chame quem mora com você. Se mora sozinha, faça mesmo assim.",
    "Acorde 30 minutos mais cedo e use esse tempo com Deus antes de qualquer tela.",
    "Vá ao culto esta semana e fique até o fim. Depois, converse com alguém da igreja que você ainda não conhece direito.",
...
CARTA = {
    ...
    "paragrafos": [
        ...
        "A ideia é simples: somos espírito, alma e corpo, e tudo anda junto. Dormir mal vira irritação. Irritação vira palavra dura. Palavra dura vira distância de quem você ama e de Deus. Por isso você vai cuidar dos três ao mesmo tempo: beber água e orar, treinar e perdoar, organizar a casa e renovar a mente. O Evangelho se vive na pia da cozinha. E tudo, tudo, é pra glorificar a Deus.",
