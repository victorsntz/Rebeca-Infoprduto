...
DESAFIOS = [
    ...
    "Se arrume pro seu dia, mesmo sem compromisso: cabelo feito, uma maquiagem, perfume, um salto confortável. \"Sê forte e corajosa\" começa no espelho (Josué 1:9).",
    ...
    "Dê um passo em algo que gera valor com as suas mãos: um serviço, um produto, uma venda. Deus preparou o que olho nenhum viu (1 Coríntios 2:9).",
