...
DESAFIOS = [
    ...
    "Monte um look que te faça sentir a mulher que Deus diz que você é. Vista hoje, mesmo sem compromisso (Provérbios 31:25).",
    ...
    "Dê um passo em algo que gera valor com as suas mãos: um serviço, um produto, uma venda. Uma ação concreta hoje (Provérbios 31:16).",
    "Escolha uma peça-chave que falta no seu visual (uma camisa boa, um sapato) e planeje a compra no orçamento. Se já tem, use hoje.",
...
LEITURAS = [
    ...
    "Filipenses 3", "Efésios 6:10-20", "1 Coríntios 13", "Filipenses 1", "Apocalipse 21:1-7",
]
...
CORPO_ALMA_ESPIRITO = {
    ...
    "intro": "A gente vive separando. Fé é domingo, corpo é academia, cabeça é terapia. A Bíblia não separa. O que você faz com um mexe nos outros dois. Um só hábito derruba os três. E um só hábito, feito com fidelidade, levanta os três.",
    "pilares": [
...
PROPOSITO_LIMITES = {
    ...
    "prop_intro": "Propósito dá direção. Sem ele, meta vira lista solta. E propósito não precisa ser extraordinário: cuidar bem da casa, ser uma filha melhor, ajudar uma amiga, pregar pros filhos. O ordinário feito com fidelidade é o extraordinário de Deus.",
    ...
    "prop_perguntas": [
        ...
        "Quem Deus já colocou perto de mim, e do que essas pessoas precisam?",
    ],
    ...
    "lim_versiculo": "Andarão dois juntos, se não estiverem de acordo?",
    "lim_ref": "Amós 3:3",
